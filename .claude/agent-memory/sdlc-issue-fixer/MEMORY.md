...
- [Asset provenance claims](project_asset_provenance_claims.md) — gh-repo-config's assets/ "extracted verbatim" claims ARE byte-diffable via a scratch clone of the marketplace repo; #43/PR #48 did this and found six divergent files.
