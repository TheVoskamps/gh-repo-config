...
- [Exercise workflow run blocks](reference_exercise_workflow_run_blocks.md) — no pyyaml (use js-yaml from node_modules, or yq); extract the block verbatim, build scratch git trees, stub the script to observe argv.
